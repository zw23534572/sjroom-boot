...
import github.sjroom.web.utils.WebUtil;
 ...
 * <p>
 * 根据自定义logger进行输出，level必须是info以下才进行输出
 * * 使用方式:
 * * 例如 logging.level.mvc.api=info 或者 logging.level.mvc.api.xxx.xxx.xxx=info ,才将制定的请求进行log输出
 * 1  优化性能
